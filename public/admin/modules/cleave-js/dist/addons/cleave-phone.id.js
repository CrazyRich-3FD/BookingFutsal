! function () {
    ...
    */
    ...
    function j(t) {
        this.H = RegExp(" "), this.B = "", this.m = new e, this.v = "", this.h = new e, this.u = new e, this.j = !0, this.w = this.o = this.D = !1, this.F = x.b(), this.s = 0, this.b = new e, this.A = !1, this.l = "", this.a = new e, this.f = [], this.C = t, this.J = this.g = E(this, this.C)
    }
    ...
    function R(t, n) {
        ...
        if (!t.j) {
            if (!t.D)
                if (P(t)) {
                    if (V(t)) return C(t)
                } else if (0 < t.l.length && (e = t.a.toString(), r(t.a), t.a.a(t.l), t.a.a(e), e = t.b.toString(), i = e.lastIndexOf(t.l), r(t.b), t.b.a(e.substring(0, i))), t.l != H(t)) return t.b.a(" "), C(t);
            return t.h.toString()
        }
        switch (t.u.b.length) {
            case 0:
            ...
            case 3:
                ...
                t.w = !0;
            default:
                return t.w ? (V(t) && (t.w = !1), t.b.toString() + t.a.toString()) : 0 < t.f.length ? (e = q(t, n), i = F(t), 0 < i.length ? i : (D(t, t.a.toString()), I(t) ? G(t) : t.j ? B(t, e) : t.h.toString())) : M(t)
        }
    }
    ...
    function F(t) {
        for (var n = t.a.toString(), e = t.f.length, r = 0; e > r; ++r) {
            var i = t.f[r],
                a = g(i, 1);
            if (new RegExp("^(?:" + a + ")$").test(n)) return t.A = st.test(h(i, 4)), n = n.replace(new RegExp(a, "g"), h(i, 2)), B(t, n)
        }
        return ""
    }
    ...
    function M(t) {
        ...
        if (3 <= n.length) {
            ...
            return D(t, n), n = F(t), 0 < n.length ? n : I(t) ? G(t) : t.h.toString()
        }
        return B(t, n)
    }
    ...
    function G(t) {
        ...
        if (e > 0) {
            ...
            return t.j ? B(t, r) : t.h.toString()
        }
        return t.b.toString()
    }

    function H(t) {
        var n, e = t.a.toString(),
            i = 0;
    ...
    function V(t) {
        ...
        return 0 == n ? !1 : (r(t.a), t.a.a(i.toString()), i = N(n), "001" == i ? t.g = A(t.F, "" + n) : i != t.C && (t.g = E(t, i)), t.b.a("" + n).a(" "), t.l = "", !0)
    }
    ...
    */
    var X = {
        ...
        tt = {
            ID: [null, [null, null, "(?:[1-79]\\d{6,10}|8\\d{7,11})", "\\d{5,12}"],
                [null, null, "2(?:1(?:14\\d{3}|[0-8]\\d{6,7}|500\\d{3}|9\\d{6})|2\\d{6,8}|4\\d{7,8})|(?:2(?:[35][1-4]|6[0-8]|7[1-6]|8\\d|9[1-8])|3(?:1|[25][1-8]|3[1-68]|4[1-3]|6[1-3568]|7[0-469]|8\\d)|4(?:0[1-589]|1[01347-9]|2[0-36-8]|3[0-24-68]|43|5[1-378]|6[1-5]|7[134]|8[1245])|5(?:1[1-35-9]|2[25-8]|3[124-9]|4[1-3589]|5[1-46]|6[1-8])|6(?:19?|[25]\\d|3[1-69]|4[1-6])|7(?:02|[125][1-9]|[36]\\d|4[1-8]|7[0-36-9])|9(?:0[12]|1[013-8]|2[0-479]|5[125-8]|6[23679]|7[159]|8[01346]))\\d{5,8}", "\\d{5,11}", null, null, "612345678"],
                [null, null, "(?:2(?:1(?:3[145]|4[01]|5[1-469]|60|8[0359]|9\\d)|2(?:88|9[1256])|3[1-4]9|4(?:36|91)|5(?:1[349]|[2-4]9)|6[0-7]9|7(?:[1-36]9|4[39])|8[1-5]9|9[1-48]9)|3(?:19[1-3]|2[12]9|3[13]9|4(?:1[69]|39)|5[14]9|6(?:1[69]|2[89])|709)|4[13]19|5(?:1(?:19|8[39])|4[129]9|6[12]9)|6(?:19[12]|2(?:[23]9|77))|7(?:1[13]9|2[15]9|419|5(?:1[89]|29)|6[15]9|7[178]9))\\d{5,6}|8[1-35-9]\\d{7,10}", "\\d{9,12}", null, null, "812345678"],
                [null, null, "177\\d{6,8}|800\\d{5,7}", "\\d{8,11}", null, null, "8001234567"],
                [null, null, "809\\d{7}", "\\d{10}", null, null, "8091234567"],
                [null, null, "804\\d{7}", "\\d{10}", null, null, "8041234567"],
                [null, null, "NA", "NA"],
                [null, null, "NA", "NA"], "ID", 62, "0(?:0[1789]|10(?:00|1[67]))", "0", null, null, "0", null, null, null, [
                    [null, "(\\d{2})(\\d{5,8})", "$1 $2", ["2[124]|[36]1"], "(0$1)"],
                    [null, "(\\d{3})(\\d{5,8})", "$1 $2", ["[4579]|2[035-9]|[36][02-9]"], "(0$1)"],
                    [null, "(8\\d{2})(\\d{3,4})(\\d{3,5})", "$1-$2-$3", ["8[1-35-9]"], "0$1"],
                    [null, "(1)(500)(\\d{3})", "$1 $2 $3", ["15"], "$1"],
                    [null, "(177)(\\d{6,8})", "$1 $2", ["17"], "0$1"],
                    [null, "(800)(\\d{5,7})", "$1 $2", ["800"], "0$1"],
                    [null, "(804)(\\d{3})(\\d{4})", "$1 $2 $3", ["804"], "0$1"],
                    [null, "(80\\d)(\\d)(\\d{3})(\\d{3})", "$1 $2 $3 $4", ["80[79]"], "0$1"]
                ], null, [null, null, "NA", "NA"], null, null, [null, null, "8071\\d{6}", "\\d{10}", null, null, "8071123456"],
                [null, null, "1500\\d{3}|8071\\d{6}", "\\d{7,10}", null, null, "8071123456"], null, null, [null, null, "NA", "NA"]
            ]
        };
    x.b = function () {
    ...
    j.prototype.K = function () {
        this.B = "", r(this.h), r(this.u), r(this.m), this.s = 0, this.v = "", r(this.b), this.l = "", r(this.a), this.j = !0, this.w = this.o = this.D = !1, this.f = [], this.A = !1, this.g != this.J && (this.g = E(this, this.C))
